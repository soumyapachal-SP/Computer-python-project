...
performance of all students in the examination\n3.Show examination statistics:\nEnter u r
choice:"))
if ch2==0:
...
print(j.loc[:,["Roll","Name","Marks"]])
5 Outputs
Describe sample outputs to demonstrate the functionalities in pro
